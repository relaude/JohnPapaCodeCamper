...
define(function (require) {
    ...
    var baseAdress = "api/useraccount";
    ...
    */
    ...
    return {
        ...
        */
        ...
        adduser: function (username, password, rolename) {
            var self = this;
            var promise = $.post(baseAdress + "/adduser", { username: username, password: password, rolename: rolename })
				.done(function (data) {
				    //router.navigateTo("/#/userslist");
				});
            return promise;
        },
